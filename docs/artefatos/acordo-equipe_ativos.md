...
A equipe será responsável pelas seguintes áreas dentro da gestão de ativos:
...
- A equipe de Gestão de Ativos não será responsabilizada por atrasos causados por falta de infraestrutura ou requisitos incompletos.  
...
- [x] Eduardo Maia Rezende: **180119231**
